		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
						<a href="index.php" class="logo" style="text-transform: uppercase">Наша психология</a>
					</div>
					<!-- /logo -->
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="post">
								...
								<div class="post-body">
									...
									<ul class="post-meta">
										<li><a href="6A8RHkvAcLI9M6zI4dNOWRg2.php">Гавриил</a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="post">
								...
								<div class="post-body">
									...
									<ul class="post-meta">
										<li><a href="lRaiJrktnrvG3f7g7.php">Гавриил</a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="post">
								...
								<div class="post-body">
									...
									<ul class="post-meta">
										<li><a href="5b8ffd338a219f8cc59ddfa1109c9a13.php">Гавриил</a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="post">
								...
								<div class="post-body">
									...
									<ul class="post-meta">
										<li><a href="c98a88ab4dc5f80ae159debf6514bbca.php">Гавриил</a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="post">
								<a class="post-img" href="NwqBK8pN3EAawNeqcaeMqxy.php"><img src="./img/006-5b4ahztvlae.jpg" alt=""></a>
								<div class="post-body">
									<h3 class="post-title"><a href="NwqBK8pN3EAawNeqcaeMqxy.php">Тема: «Социальный генезис: предпосылки и развитие»</a></h3>
									<ul class="post-meta">
										<li><a href="NwqBK8pN3EAawNeqcaeMqxy.php">Гавриил</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<ul>
								<li>
									<a href="#" class="social-facebook">
										...
										<span>65.3K<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-twitter">
										<i class="fa fa-twitter"></i>
										<span>254.4<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-google-plus">
										<i class="fa fa-google-plus"></i>
										<span>166.8<br>Followers</span>
									</a>
								</li>
							</ul>
						</div>
