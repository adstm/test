		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
						<a href="index.php" class="logo" style="text-transform: uppercase">Психология</a>
					</div>
					<!-- /logo -->
							...
							<ul>
								<li>
									<a href="#" class="social-facebook">
										...
										<span>161.6K<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-twitter">
										<i class="fa fa-twitter"></i>
										<span>79.5<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-google-plus">
										<i class="fa fa-google-plus"></i>
										<span>138.3<br>Followers</span>
									</a>
								</li>
							</ul>
						</div>
